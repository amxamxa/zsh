...
**/# >/dev/null 2>&1 leitet alle Ausgaben (stdout und stderr) ins Nirvana& Terminal bleibt sauber
open_pdf() {
...
################################################################
# alias mangconf='echo -e "\t${PINK}Öffne MangoHud Konfigurationsdatei${RESET}" && micro -filetype bash "$XDG_CONFIG_HOME/MangoHud/MangoHud.conf"'https://www.youtube.com/watch?v=jVmtUvaxxbI
# alias mango='echo -e "\t${PINK}Starte glxgears mit MangoHud Overlay${RESET}" && mangohud glxgears &'
# alias nvidia-settings='nvidia-settings --config="$XDG_CONFIG_HOME/nvidia-settings-rc"'
