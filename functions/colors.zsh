...
export GREEN=$(fg_bg_hex 	"00FF00" "006400")    && echo "\t${GREEN}  
 🙼 🙼  󱢇  󰧼  󱚡    🙽  󰧼  󱚡    🙽  🙼GREEN"  # Hell auf Dunkel 


export RED=$(fg_bg_hex 		"F08080" "8B0000")    && echo "\t${RED} 󱢇  Das ist env-Variable RED"  # Hell auf Dunkel
...
export NIGHT=$(fg_bg_hex 	"fcde5a" "00008B")    && echo "\t${NIGHT} Das ist env-Variable NIGHT${RESET} \t󱢇  __________________________________ 󱢇 "  # Hell auf Dunkel
