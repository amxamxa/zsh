...
ä🙽 🙽 🙽 🙽 ${RESET}" | lolcat -f --seed=4 --spread=0.5 --freq=0.3
...
echo -e " ${YELLO} 🙼    YELLO - Bright yellow TXT on gold bg   🙼    ${RESET}
 ${LAVEN} 🙽    LAVEN - Lavender TXT on deep purple bg 🙽   ${RESET}
 ${PINK2} 🙼    PINK2 - Hot pink TXT on dark rose bg    🙽  ${RESET}
 ${RASPB} 🙽    RASPB - Raspberry TXT on dark wine bg   🙼  ${RESET}
 ${VIOLE} 🙼    VIOLE - Violet TXT on deep violet bg  🙼    ${RESET}
 ${BROWN} 🙽    BROWN - Brown TXT on dark brown bg  🙼      ${RESET}
 ${IVORY} 🙼    IVORY - Ivory TXT on warm grey bg   🙽      ${RESET}
 ${SLATE} 🙽    SLATE - Slate TXT on dark slate bg   🙽     ${RESET}
 ${INDIG} 🙼    INDIG - Indigo TXT on deep indigo bg 🙼     ${RESET}
 ${PLUM} 🙼     PLUM - PLUMgo TXT on deep indigo bg 🙼     ${RESET}
 ${EMBER} 🙽   EMBER - Ember TXT on dark ember bg  🙼      ${RESET}
 ${CORAL} 🙼    CORAL - Coral TXT on muted coral bg 🙽      ${RESET}
 ${GOLD}🙼      GOLD - Gold TXT on dark gold bg    🙼      ${RESET}
 ${OLIVE}🙽     OLIVE - Olive TXT on dark olive bg  🙽      ${RESET}
 ${GREY} 🙼      GREY - Light grey TXT on grey bg    🙼     ${RESET}
 ${CYAN} 🙽      CYAN - Cyan TXT on dark cyan bg   🙼       ${RESET}
 ${TEAL} 🙼      TEAL - Teal TXT on dark teal bg   🙽       ${RESET}
 ${MINT} 🙽      MINT - Mint TXT on deep mint bg     🙽     ${RESET}
 ${SKY}  🙼       SKY - Sky blue TXT on dusk blue bg   🙽  ${RESET}"
#echo -e " 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 🙼 ${RESET}" | lolcat -f --seed=5 --spread=0.5 --freq=0.2
echo -e "  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  🙼  ${RESET}" | lolcat -if --seed=5 --spread=0.5 --freq=0.2
